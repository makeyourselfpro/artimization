...
const ContainerFooter = () => {
  return (
    <div className="absolute w-full top-[9109.7px] right-[0px] left-[0px] bg-gray-700 flex flex-col items-center justify-start pt-[82px] px-[375px] pb-3 box-border text-center text-25xl text-gainsboro-200 font-lato">
      <div className="relative w-[1170px] h-[586.64px]">
        <ContainerForm dimensionLabel="/mobilenavlogopng@2x.png" />
        <div className="absolute w-[calc(100%_-_626.41px)] top-[439.77px] right-[15px] left-[611.41px] flex flex-col items-start justify-start pt-0 px-0 pb-[4.999998092651367px] box-border gap-[13.99px] text-xs text-lightgray">
        ...
        <Footer
          dimensionCode="/divflags@2x.png"
          dimensionCodeImageUrl="/divflagsa@2x.png"
        />
        <div className="absolute w-[calc(100%_-_30px)] top-[519.8px] right-[15px] left-[15px] box-border h-[31px] flex flex-row items-start justify-start pt-4 px-0 pb-0 gap-[281.21px] text-sm border-t-[1px] border-solid border-white">
          <div className="relative w-[396.56px] h-[30px]">
            <div className="absolute top-[0px] left-[calc(50%_-_198.28px)] flex flex-row items-center justify-center py-0 pr-[9px] pl-0">
              <img
                className="relative w-[50px] h-[30px] object-cover"
                alt=""
                src="/dmca-protected-1-120png@2x.png"
              />
            </div>
