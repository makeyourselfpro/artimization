...
const Header = () => {
  ...
  const onDivcolSm3ContainerClick = useCallback(() => {
    router.push("/");
  }, [router]);

  const onLogosvgImageClick = useCallback(() => {
    router.push("/");
  }, [router]);

  return (
    <div className="absolute w-full top-[0px] right-[0%] left-[0%] flex flex-col items-center justify-start pt-[30px] px-[375px] pb-0 box-border text-left text-xl text-white font-font-awesome-5-free">
      <div className="w-[1170px] flex flex-col items-start justify-start py-0 px-[15px] box-border">
        <div className="self-stretch flex flex-col items-center justify-start">
          <div className="w-[1140px] flex flex-row items-center justify-start">
            <div
              className="w-[285px] flex flex-row items-center justify-start py-0 pr-[30px] pl-0 box-border relative min-h-[1px] cursor-pointer text-center"
              onClick={onDivcolSm3ContainerClick}
            >
              <div className="flex flex-col items-start justify-start z-[0]">
                <div className="self-stretch flex flex-col items-start justify-start">
                  <div className="w-[255px] h-[50px] flex flex-col items-center justify-center pt-[1.2632979154586792px] px-0 pb-[1.2632981538772583px] box-border max-w-[255px]">
                    <img
                      className="relative w-[255px] h-[47.47px] overflow-hidden shrink-0 cursor-pointer"
                      alt=""
                      src="/logosvg.svg"
                      onClick={onLogosvgImageClick}
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-row items-center justify-end relative gap-[0.01px]">
                ...
                <div className="w-[166.09px] flex flex-col items-start justify-start py-0 px-2 box-border z-[1] text-sm">
                  <div className="self-stretch relative rounded-10xs box-border h-9 border-[2px] border-solid border-white">
                    <div className="absolute top-[27.89px] left-[21.78px] leading-[14px] uppercase [transform:_rotate(-156deg)] [transform-origin:0_0]">
                      
                    </div>
